...
public class PlayerCollider : MonoBehaviour
{
  ...
  public string two;
    ...
    void Start()
    {
        ...
        robotscale1 = transform.localScale + sc_1; //0 to 1
        robotscale2 = transform.localScale + sc_2; //1 to 2
        robotscale3 = transform.localScale + sc_3; //2 to 3
        robotscale0 = transform.localScale; // to 0
    ...
    void FixedUpdate()
    {
      ...
      */
      ...
      Debug.DrawLine(camera2object.transform.position + 50*camera2object.transform.forward, camera2object.transform.position - 100*camera2object.transform.forward , Color.red);
      Debug.DrawLine(camera3object.transform.position + 50*camera3object.transform.forward, camera3object.transform.position - 100*camera3object.transform.forward , Color.red);
